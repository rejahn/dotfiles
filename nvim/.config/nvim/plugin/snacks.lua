...
map("<leader>lg", function() Snacks.lazygit() end, "Lazygit")
map("<leader>:", function() Snacks.picker.command_history() end, "Command History")
map("<leader>'", function() Snacks.picker.resume() end, "Resume picker")
map("<leader>/", function() Snacks.picker.grep() end, "Live grep")
map("<leader>?", function() Snacks.picker.commands() end, "Commands")
map("<leader><leader>", function() Snacks.picker.recent() end, "Recent files")
map("<leader>H", function() Snacks.picker.help() end, "Help tags")
map("<leader>d", function() Snacks.picker.diagnostics_buffer() end, "Document diagnostics")
map("<leader>D", function() Snacks.picker.diagnostics() end, "Workspace diagnostics")
map("<leader>s", function() Snacks.picker.lsp_symbols() end, "Document symbols")
...
map("<leader>th", function() Snacks.toggle.inlay_hints():toggle() end, "Toggle Inlay Hints")
